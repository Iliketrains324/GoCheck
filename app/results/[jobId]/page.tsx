  ...
  for (const [docType, result] of entries) {
    ...
    children.push(
      new Paragraph({
        ...
        border: {
          bottom: { style: BorderStyle.SINGLE, size: 4, color: "ccddcc" },
        },
      })
    );
    ...
    if (result.issues.length === 0) {
      ...
      for (const issue of result.issues) {
        ...
        // Checkbox + severity badge + field name
        children.push(
          new Paragraph({
            children: [
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 mb-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 border border-outline-variant text-primary px-5 py-2.5 rounded-xl font-headline font-bold hover:bg-surface-container transition-all text-sm"
            >
              <span className="material-symbols-outlined text-base">download</span>
              Export Checklist (.docx)
            </button>
            <Link
              href="/upload"
